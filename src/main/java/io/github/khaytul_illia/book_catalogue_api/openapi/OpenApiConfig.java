package io.github.khaytul_illia.book_catalogue_api.openapi;
        ...
        Components components = new Components()
            ...
            .addResponses(
                ...
                buildApiResponse(
                    ...
                    new BookResponse(1L, "Good Book Vol.1", "Lorem ipsum dolor sit amet",
            ...
            .addResponses(
                ...
                buildApiResponse(
                    ...
                    new BookResponse(1L, "Good Book Vol.1", "Lorem ipsum dolor sit amet",
                        "Original Author", 200, LocalDate.parse("2026-08-15"))
                ).headers(Map.of("Location", new Header().schema(new StringSchema().example("/api/v1/books/1"))))
            )
            .addResponses(
                "book_page_response",
                buildApiResponse(
                    "PaginatedResponse",
                    "Operation successful",
                    new PaginatedResponse<>(5, 10, 2, 50, List.of(
            ...
            .addResponses(
                "400_response",
                buildExceptionApiResponse(
                    "Invalid parameters",
                    new ErrorResponse(HttpStatus.BAD_REQUEST, "Invalid request parameters",
            ...
            .addResponses(
                ...
                buildExceptionApiResponse(
                    ...
                    new ErrorResponse(HttpStatus.UNAUTHORIZED, "Full authentication is required to access this resource"))
            )
            .addResponses(
                "404_response",
                buildExceptionApiResponse(
                    "Entity not found",
                    new ErrorResponse(HttpStatus.NOT_FOUND, "Book with id 1 does not exist")
                )
            )
            .addResponses(
                "409_response",
                buildExceptionApiResponse(
                    "Entity parameter conflict",
                    new ErrorResponse(HttpStatus.CONFLICT, "A book with title 'book1' by 'author' already exists"))
            );
