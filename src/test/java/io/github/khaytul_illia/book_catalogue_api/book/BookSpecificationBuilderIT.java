...
@Import({BookService.class, BookSpecificationBuilder.class, TestcontainersConfiguration.class})
@ActiveProfiles("test")
@DisplayName("Book specifications integration tests")
public class BookSpecificationBuilderIT{
    ...
    void shouldReturnAllBooks_whenFilteringEmpty(){
        ...
        assertThat(books.stream().map(BookResponse::id)).containsExactlyInAnyOrder(book1.getId(), book2.getId(), book3.getId());
    }
    ...
    void shouldReturnBooksWhereTitleContainsValue(){
        ...
        assertThat(books.stream().map(BookResponse::id)).containsExactlyInAnyOrder(book1.getId(), book2.getId());
    }
    ...
    void shouldReturnBooksWhereAuthorNameContainsValue(){
        ...
        assertThat(books.stream().map(BookResponse::id)).containsExactlyInAnyOrder(book3.getId());
    }
    ...
    void shouldReturnBooksWithMinPages(){
        ...
        List<BookResponse> books = response.content();
        assertThat(books).hasSize(2);
        assertThat(books.stream().map(BookResponse::id)).containsExactlyInAnyOrder(book2.getId(), book3.getId());
    }
    ...
    void shouldReturnBooksByMinPagesAndReleasedAfter(){
        ...
        List<BookResponse> books = response.content();
        assertThat(books).hasSize(1);
        assertThat(books.stream().map(BookResponse::id)).containsExactlyInAnyOrder(book2.getId());
    }
    ...
    void shouldReturnBookThatMatchesAllSpecifications(){
        ...
        List<BookResponse> books = response.content();
        assertThat(books).hasSize(1);
        assertThat(books.stream().map(BookResponse::id)).containsExactlyInAnyOrder(book1.getId());
    }
}
